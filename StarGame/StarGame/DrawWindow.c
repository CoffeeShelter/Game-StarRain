...
//			case HEALINGSTAR:
//				SetColor(0, 12);
//				WriteBuffer(col, line, "H");
//				SetColor(0, 15);
//				break;
//				//빨리빨리 별똥별 : 파란색
//			case FASTSTAR:
//				SetColor(0, 9);
//				WriteBuffer(col, line, "F");
//				SetColor(0, 15);
//				break;
//				//튼튼 별똥별 : 회색
//			case STRONGSTAR:
//				SetColor(0, 8);
//				WriteBuffer(col, line, "S");
//				SetColor(0, 15);
//				break;
//				//무시무시 별똥...별? (즉사 별똥별) : 빨강색
//			case DEATHSTAR:
...
//	SetColor(8, 10);
//	WriteBuffer(5, GAMEBOARD_LINES + 1, "HP");
//
//	//GotoXY(9, GAMEBOARD_LINES + 1);
//	SetColor(12, 0);
//	for (int i = 0; i < player->hp; i++) {
//		WriteBuffer(9+i, GAMEBOARD_LINES + 1, " ");
//	}
//
//
//	//BOOST
...
//	SetColor(8, 10);
//	WriteBuffer(3, GAMEBOARD_LINES + 3, "BOOST");
//
//	//GotoXY(9, GAMEBOARD_LINES + 3);
//	SetColor(9, 0);
//	for (int i = 0; i < player->boost; i++) {
//		WriteBuffer(9+i, GAMEBOARD_LINES + 3, " ");
//	}
//
//
//	//SCORE
...
//	SetColor(8, 10);
//	WriteBuffer(25, GAMEBOARD_LINES + 2, "SCORE");
//
//	//GotoXY(31, GAMEBOARD_LINES + 2);
//	sprintf(strBuf, "%d", player->score);
//	WriteBuffer(31, GAMEBOARD_LINES + 2, strBuf);
//
//	SetColor(0, 15);
//	GotoXY(0, 0);
//
